...
- (id)initWithRadius:(float)radius levels:(int)n {
	...
	return [super initWithMode:GL_TRIANGLE_STRIP vertices:(GLfloat*)vertices vertexCount:sizeof(vertices)/sizeof(GLfloat)/8 indices:indices indexCount:sizeof(indices)/sizeof(GLushort) vertexSize:3 texCoordsSize:0 normalSize:3 colorSize:0 isDynamic:NO];
}
